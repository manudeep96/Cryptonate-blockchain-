    ...
    try {
      ...
      if (typeof provider !== 'undefined') {
        ...
        .then((accounts) => {
          ...
          if (role === 'donor'){
            const res = nftContract.methods.checkValidDonor(selectedAccount).call({from: selectedAccount});
            ...
            const res = nftContract.methods.checkValidCharity(selectedAccount).call({from: selectedAccount});
            const printAddress = async () => {
              const a = await res;
              console.log(a);
              if(a === true){
